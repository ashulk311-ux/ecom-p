...
import { FiPlus, FiEdit, FiTrash2, FiX, FiMenu } from 'react-icons/fi';
import RestaurantMenuManager from './RestaurantMenuManager';
import './ContentManagement.css';

const ContentManagement = () => {
  const [activeModule, setActiveModule] = useState('restaurants'); // Food app only manages restaurants
  ...
  return (
    <div className="content-management">
      ...
      {/* Module tabs hidden for food app - only manages restaurants */}
