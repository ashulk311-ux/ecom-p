...
const DealSlider = ({ items, onAddToCart }) => {
  ...
  const scroll = (direction) => {
    if (scrollRef.current) {
      ...
      console.log('Element:', scrollRef.current);
      console.log('Computed style:', window.getComputedStyle(scrollRef.current).overflowX);
      ...
      console.error('Scroll ref not available');
    }
  };
